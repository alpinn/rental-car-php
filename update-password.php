...
<title>Easy Car || Update Password</title>
<!--Bootstrap -->
  ...
  <div class="container">
    <div class="user_profile_info gray-bg padding_4x4_40">
      ...
      <div class="dealer_info">
        <h5>Full Name: <?php echo htmlentities($result->FullName);?></h5>
        <p>Address: <?php echo htmlentities($result->Address);?><br>Country & City: 
