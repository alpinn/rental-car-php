...
<link rel="shortcut icon" href="assets/images/favicon-icon/logo-white.png">
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <p>Choose from a wide range of cars that fit your style and budget. Experience the freedom of the open road with our reliable and efficient rental service.</p>
            <a href="#collection" class="btn">Read More <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<!-- Resent Cat-->
<section class="section-padding gray-bg" id="collection">
  <div class="container">
    <div class="section-header text-center">
      <h2>Our Impressive <span> Collection of Cars</span></h2>
...
<div class="car-info-box"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" alt="image" style="width:200px; height:200px; margin:auto;"></a>
<ul>
