...
<?php }} ?>
      ...
      <aside class="col-md-3">
        ...
        <div class="share_vehicle">
          <p>Share: <a href="#"><i class="fa fa-facebook-square" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-twitter-square" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-linkedin-square" aria-hidden="true"></i></a> </p>
        </div>
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-envelope" aria-hidden="true"></i>Book Now</h5>
            <p style="font-size: 15px; color:red; font-weight:bold;"><span style="color:red; ">*</span> payment and the cars will be at your address after the transaction is confirmed</p>
          </div>
          <form method="post">
